...
window.editarFunc = (id) => {
    ...
    $('func_id_edit').value = f.id; $('func_nome').value = f.nome; $('func_cargo').value = f.cargo; $('func_cpf').value = f.cpf; $('func_telefone').value = f.telefone; $('func_salario').value = f.salario; $('func_admissao').value = f.data_admissao;
...
window.editarForn = (id) => {
    ...
    $('forn_id_edit').value = f.id; $('forn_nome').value = f.nome; $('forn_documento').value = f.documento; $('forn_telefone').value = f.telefone; $('forn_email').value = f.email; $('forn_cidade').value = f.cidade;
